module github.com/trivelaapp/go-kit/examples/grpc_communication

go 1.18

require (
	github.com/trivelaapp/go-kit/errors v0.2.0
	github.com/trivelaapp/go-kit/grpc v0.1.0
...
require (
	...
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/exporter/metric v0.28.0 // indirect
	...
	github.com/trivelaapp/go-kit/http v0.5.4 // indirect
	github.com/ugorji/go/codec v1.2.7 // indirect
	go.opencensus.io v0.23.0 // indirect
	go.opentelemetry.io/contrib/instrumentation/github.com/gin-gonic/gin/otelgin v0.31.0 // indirect
